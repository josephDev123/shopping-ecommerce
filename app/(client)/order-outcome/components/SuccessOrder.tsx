          ...
          <table className="table-fixed">
            ...
            <tr>
              ...
              <td className="px-4">
                ...
                deleniti, illum fugit necessitatibus eaque reprehenderit neque
                ab accusamus amet tempora non. Reprehenderit, neque? Unde
                corporis officia quis assumenda in. Aperiam!
              </td>
            </tr>
            <tr>
